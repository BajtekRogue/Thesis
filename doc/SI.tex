...
Aby $v$ został zainfekowany, wystarczy, że po kolei na tej ścieżce zajdą sukcesy transmisji.
...
Jeśli chociaż jedno ze zdarzeń $A_k$ zajdzie to wtedy $X_v<\infty$.
Mamy zatem
\begin{equation*}
\begin{aligned}
\mathbb{P}[X_v=\infty] &\le \mathbb{P}\Big[\bigcap_{k=0}^{\infty} A_k^c\Big] = \lim_{m\to \infty} \mathbb{P}\Big[\bigcap_{k=0}^m A_k^c\Big] \\
...
\[
    \lim_{t\to\infty} \mathbb{E}[Y_t]=\mathbb{E}[\lim_{t\to\infty} Y_t] = \mathbb{E}\left[\lim_{t\to\infty} \sum_{v\in V} \mathbf{1}_{v\in\mathcal{I}_t}\right]=\mathbb{E}\left[\lim_{t\to\infty}\sum_{v\in V} 1 \right] = \mathbb{E} [|V|] = |V|.
\]
Wreszcie $\mathbb{P}[Z = \infty] =  \mathbb{P}[\max_{v\in V} X_v = \infty] = 0$ skąd $\mathbb{P}[Z<\infty]=1$.
\end{proof}
