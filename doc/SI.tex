...
Wyniki eksperymentu niemal idealnie pokrywają się z przewidywaniami, to jest $1+tp$ dla $\mathbb{E}[Y_t]$ (zob. \cref{fig:path_Yt}) oraz $\frac{n-1}{p}$ dla $\mathbb{E}[Z]$ (zob. \cref{fig:path_Z}).

\begin{figure}[ht!]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/path/final_infection_expectations.png}
    \caption{$\mathbb{E}[Y_t]$ dla $\mathrm{P_n}$ w funkcji $t$.}
    \label{fig:path_Yt}
\end{figure}
\begin{figure}[ht!]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/path/full_infection_expectation.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/star/final_infection_expectations.png}
    \caption{$\mathbb{E}[Y_t]$ dla $\mathrm{S_n}$ w funkcji $t$.}
    \label{fig:star_Yt}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/star/full_infection_expectation.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/cycle/final_infection_expectations.png}
    \caption{$\mathbb{E}[Y_t]$ dla $\mathrm{C_n}$ w funkcji $t$}
    \label{fig:cycle_Yt}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/cycle/full_infection_expectation.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/complete/final_infection_expectations.png}
    \caption{$\mathbb{E}[Y_t]$ dla $\mathrm{K_n}$ w funkcji $t$}
    \label{fig:complete_Yt}
\end{figure}
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{../img/SI/complete/full_infection_expectation.png}
