...
= \sum_{k=1}^{\infty} \big(1 - \mathbb{P}[Z \le k-1]\big)
= \sum_{k=1}^{\infty} \big(1 - (1 - q^{k-1})^n\big) \\[2mm]
&= \sum_{k=0}^{\infty} \big(1 - (1 - q^k)^n\big)
...
Wyniki przedstawiono na \Cref{fig:star_Yt,fig:star_Z}.
