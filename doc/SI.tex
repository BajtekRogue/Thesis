...
Jeśli chodzi o liczbę zainfekowanych po $t$ krokach, to mamy trzy wartości do policzenia. 
...
Mamy $T_h = U_1 + \cdots +U_h$ oraz $Z=T_h$ a więc
\begin{equation*}
\begin{aligned}
    \mathbb{E}[Z] 
    &= \mathbb{E}[T_h] 
...
\end{aligned}
\end{equation*}
gdzie w linijce pierwszej wykorzystujemy \cref{lemma:helper_lemma}, w drugiej \cref{inequality:harmonic_upper_bound} a w ostatniej nierówność między średnimi (\ref{inequality:AM_GM}).
\end{proof}
...
Widzimy zatem, że nasze ograniczenia nie są do poprawienia bez dodatkowych parametrów drzewa. 
