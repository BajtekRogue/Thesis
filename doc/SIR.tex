...
Dzieje się to z prawdopodobieństwem $1-q\beta$ a więc $Z\sim\mathrm{Geo}(1-q\beta)$.
Mamy
\[
...
Dla $v\in\{1,2,\dots,n\}$ mamy $X_v\sim\mathrm{KGeo}(p,\alpha)$.
...
Przypomnijmy, że rozkład ten wynosi $1+B_{j,t}$ gdzie $B_j\sim\mathrm{Bin}(n,1-q^{\min\{j,t\}})$.
A więc
\[
