...
Aby mieć pewność, że infekcji umrze w sensownym czasie będziemy badać propagacje dla parametrów $p=0.1,\;\alpha=0.9$ (\Cref{fig:SIS_p0.1_a0.9}), $p=0.2,\;\alpha=0.8$ (\Cref{fig:SIS_p0.2_a0.8}) oraz $p=0.5,\;\alpha=0.9$ (\Cref{fig:SIS_p0.5_a0.9}).
