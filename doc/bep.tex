...
% A zatem algorytm po co najwyżej $D$, gdzie $D$ jest średnicą grafu, osiąga punkt stały i dalsza propagacja nie jest konieczna.
...
% W przypadku pełnej niezawodności kanałów komunikacyjnych górne ograniczenie to $T\le D$.
...
% Krok aktualizacji wartości jest analogiczny do rozprzestrzeniania się infekcji w modelu SI.
% Dla ustalonego $s\in V$ zmienne losowe, które zdefiniowaliśmy dostarczają nam sporo informacji o przebiegu algorytmu BEP.
