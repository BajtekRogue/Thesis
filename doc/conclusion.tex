...
Na myśl nasuwa się także możliwość zbadania bardziej skomplikowanych modeli epidemiologicznych, takich jak SEIR (Susceptible-Exposed-Infected-Recovered), czy też SIRD (Susceptible-Infectious-Recovered-Deceased).


Podsumowując, modele probabilistycznej propagacji w grafach stanowią ogromne pole badawcze, które łączy ze sobą rachunek prawdopodobieństwa, teorię grafów i procesy stochastyczne. 
