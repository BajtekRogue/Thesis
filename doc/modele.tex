...
Przyjmujemy, że w każdej rundzie wierzchołki najpierw przekazują infekcję, a potem dopiero mogą wyzdrowieć. 
Dla uproszczenia notacji kładziemy 
\[
...
\[
    W = |\{v\in V : X_v < \infty\}|.
\]
Rozkłady $Z,W$ jak i ich wartości oczekiwane będą naszym głównym zainteresowaniem w tym modelu.
